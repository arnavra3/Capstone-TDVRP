...
int main()
{
    ...
    // Counters for categorized results
    struct Stats
    {
    ...
    while (load_next_instance(file, layout))
    {
        ...
        // Run Versions V1, V2, V3
        bool s1 = (solve_seqsl(1, rng) != "INFEASIBLE");
        bool s2 = (solve_seqsl(2, rng) != "INFEASIBLE");
        bool s3 = (solve_seqsl(3, rng) != "INFEASIBLE");

        // Run V4 (20 Iterations)
        int b4 = 1e9;
        for (int i = 0; i < 20; i++)
        {
            string r = solve_seqsl(4, rng);
            if (r != "INFEASIBLE")
                b4 = min(b4, stoi(r));
        }
        bool s4 = (b4 != 1e9);
    ...
    cout << "=======================================================\n";
    cout << "   SEQSL (HETEROGENEOUS SMALL-TO-LARGE) RESULTS\n";
    cout << "=======================================================\n";
