...
// =======================================================
// V3 LOGIC: Earliest Finish Time (Availability)
// =======================================================
bool better_candidate(const Candidate &a, const Candidate &b)
{
    ...
    // 1. PRIMARY COST FUNCTION: Earliest Finish Time
    // This perfectly evaluates Travel + Wait + Service Time.
    // It picks the move that makes the truck available for its NEXT job the soonest.
    ...
    // 3. TERTIARY: If they finish at the exact same time, break tie using shortest travel time.
...
Candidate eval_move(const Vehicle &v, int cust_id, bool new_truck)
{
    ...
    // V3 CRITICAL MATH: The true cost is when the service is completely done.
...
int main()
{
    ...
    cout << "=======================================================\n";
    cout << "  V3 SMART BASELINE (EARLIEST FINISH TIME)\n";
    cout << "=======================================================\n";
    p("OVERALL", o);
    p("CLUSTERED (C)", c);
    p("RANDOM (R)", r);
